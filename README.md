...
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_run.PNG"/></div>

Then we go to EC2 link  
and meet the login website (html file is `login.html` in templates folder)  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_login.PNG"/></div>

We can register one account (`register.html`)  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_register.PNG"/></div>
...
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_upload.PNG"/></div>
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_update.PNG"/></div>
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_save.PNG"/></div>

Then we can click "Analyze" to nlp analyze the articles, we can select the article to analyze  
Username is shown in "Hello username" and all files under this user_id will also be shown  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_select.PNG"/></div>

After selected the files to analyze, we can do nlp analysis  
Username is shown in "Hello username" and all files under this user_id will also be shown  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_analysis1.PNG"/></div>
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_keyword.PNG"/></div>
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_file_sentiment.PNG"/></div>
...
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_nlp.PNG.PNG"/></div>
...
On EC2 Run `sudo python3 ec2_fileuploader.py`  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_news_run.PNG"/></div>

Then we go to EC2 link  
and meet the login website (html file is `login.html` in templates folder)  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_news_login.PNG"/></div>
...
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_news_ingest.PNG"/></div>
...
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_news_select.PNG"/></div>

After selected the files to analyze, we can do nlp analysis  
<div align=center><img width='500'src="https://github.com/BUEC500C1/news-analyzer-JimY233/blob/main/Figures/ec2_news_sentiment.PNG"/></div>
